...
### 1.7 Plată — ✅ DECIS (Stripe+Billing) · 🔨 Felia 1 + 4a FĂCUTE
...
- ⬜ **Felia 4b** — aplicarea gating (router namespace→tier + helper _require_tier bot+web + teaser reconciliere blocat). Următoarea.
- Felii rămase: 2 webhook Stripe (cere chei test), 3 Oblio factură (cere DATE CONIAR furnizor — CUI/reg.com./sediu/IBAN, LIPSESC), 4b gating features.
