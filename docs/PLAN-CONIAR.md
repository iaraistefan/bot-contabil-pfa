...
- Felii rămase: 2b checkout (cere Products/Prices în Stripe) + 2c webhook (cere chei test — cont Stripe împreună cu Stefan), 3 Oblio factură (cere DATE CONIAR furnizor — CUI/reg.com./sediu/IBAN, LIPSESC).
